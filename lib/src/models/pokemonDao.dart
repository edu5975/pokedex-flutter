...
class PokemonDao {
  ...
  PokemonDao fromJson(Map<String, dynamic> json) {
    PokemonDao pokemon = PokemonDao();
    if (json['abilities'] != null) {
      pokemon.abilities = new List<Abilities>();
      json['abilities'].forEach((v) {
        pokemon.abilities.add(new Abilities.fromJson(v));
      });
    }
    pokemon.baseExperience = json['base_experience'];
    if (json['game_indices'] != null) {
      pokemon.gameIndices = new List<GameIndices>();
      json['game_indices'].forEach((v) {
        pokemon.gameIndices.add(new GameIndices.fromJson(v));
      });
    }
    pokemon.height = json['height'];
    pokemon.id = json['id'];
    pokemon.isDefault = json['is_default'];
    pokemon.locationAreaEncounters = json['location_area_encounters'];
    if (json['moves'] != null) {
      pokemon.moves = new List<Moves>();
      json['moves'].forEach((v) {
        pokemon.moves.add(new Moves.fromJson(v));
      });
    }
    pokemon.name = StringUtils.capitalize(json['name']);
    pokemon.order = json['order'];
    pokemon.species =
        json['species'] != null ? new Ability.fromJson(json['species']) : null;
    if (json['stats'] != null) {
      pokemon.stats = new List<Stats>();
      json['stats'].forEach((v) {
        pokemon.stats.add(new Stats.fromJson(v));
      });
    }
    if (json['types'] != null) {
      pokemon.types = new List<Types>();
      json['types'].forEach((v) {
        pokemon.types.add(new Types.fromJson(v));
      });
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['name'] = StringUtils.capitalize(this.name);
...
class Ability {
  ...
  Ability.fromJson(Map<String, dynamic> json) {
    name = StringUtils.capitalize(json['name']);
    url = json['url'];
  }
